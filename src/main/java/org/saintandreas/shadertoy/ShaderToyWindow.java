...
public class ShaderToyWindow extends RenderWindow {
  ...
  static {
    ResourceManager.setProvider(new FilesystemResourceProvider(new File(
        "C:\\Users\\bdavis\\Git\\shadertoy\\src\\main\\resources")));
  }
  ...
  public void drawFrame() {
    ...
    Program program = OpenGL.getProgram(new BasicResource("Shadertoy.vs"), new BasicResource("Shadertoy.fs"));
    program.use();
